...
id_missing_processed_data = copy.deepcopy(
    good_processed_data
)  # an entry assigned ID 0 by read_lexicon()
id_missing_processed_data.append(
    {
        "ant": "",
        "check": "",
...
jumbled_lexicon_entries = [
    LexiconEntry("x test_word_1", {}),
    LexiconEntry("Test_word_1", {}),
]
